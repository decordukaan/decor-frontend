          ...
          <section className='relative flex h-[360px] lg:h-full items-end bg-gray-900 lg:col-span-5 xl:col-span-6'>
            ...
            <div className='hidden lg:relative lg:block lg:p-12'>
              ...
              <p className='mt-4 leading-relaxed text-white/90 text-[18px] max-w-[80%]'>
                Discover a world of elegant home decor at Decor Dukaan. Sign in
                to explore our latest collections, exclusive deals, and
                personalized recommendations to beautify your space
                effortlessly.
              </p>
            </div>
